...
const es = {
    ...
    items: {
      care: {
        ...
        features: [
          ...
          'Centro digital de bienestar Proactiva',
        ],
      },
      plus: {
  ...
  ctaSection: {
    ...
    nameValidationHint: 'Solo letras, entre 1 y 32 caracteres.',
    phoneValidationHint: 'Solo números de teléfono, con o sin código de país (ej: +54 9 11 1234-5678).',
